...
class PandaRubikEngine(RubikEngine):
    def __init__(self, position_x, position_y, position_z, viewer3D):
        ...
        # Load central cubes        
        self.rotation_cube = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/central_cube.gltf")
        self.rotation_cube.setPos(position_x, position_y, position_z)
        self.rotation_cube.reparentTo(self.viewer3D.render)

        self.static_cube = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/central_cube.gltf")
        ...
        self.cube_front_down_left_corner = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/corner_cubes/cube_front_down_left_corner.gltf")
        self.cube_front_down_left_corner.reparentTo(self.static_cube)

        self.cube_front_down_edge = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/edge_cubes/cube_front_down_edge.gltf")
        self.cube_front_down_edge.reparentTo(self.static_cube)

        self.cube_front_down_right_corner = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/corner_cubes/cube_front_down_right_corner.gltf")
        self.cube_front_down_right_corner.reparentTo(self.static_cube)
        
        self.cube_down_left_edge = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/edge_cubes/cube_down_left_edge.gltf")
        self.cube_down_left_edge.reparentTo(self.static_cube)

        self.cube_down_center = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/center_cubes/cube_down_center.gltf")
        self.cube_down_center.reparentTo(self.static_cube)

        self.cube_down_right_edge = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/edge_cubes/cube_down_right_edge.gltf")
        self.cube_down_right_edge.reparentTo(self.static_cube)

        self.cube_back_down_left_corner = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/corner_cubes/cube_back_down_left_corner.gltf")
        self.cube_back_down_left_corner.reparentTo(self.static_cube)

        self.cube_back_down_edge = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/edge_cubes/cube_back_down_edge.gltf")
        self.cube_back_down_edge.reparentTo(self.static_cube)

        self.cube_back_down_right_corner = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/corner_cubes/cube_back_down_right_corner.gltf")
        self.cube_back_down_right_corner.reparentTo(self.static_cube)

        # Load up face cubes
        self.cube_front_up_left_corner = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/corner_cubes/cube_front_up_left_corner.gltf")
        self.cube_front_up_left_corner.reparentTo(self.static_cube)

        self.cube_front_up_edge = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/edge_cubes/cube_front_up_edge.gltf")
        self.cube_front_up_edge.reparentTo(self.static_cube)

        self.cube_front_up_right_corner = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/corner_cubes/cube_front_up_right_corner.gltf")
        self.cube_front_up_right_corner.reparentTo(self.static_cube)
        
        self.cube_up_left_edge = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/edge_cubes/cube_up_left_edge.gltf")
        self.cube_up_left_edge.reparentTo(self.static_cube)

        self.cube_up_center = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/center_cubes/cube_up_center.gltf")
        self.cube_up_center.reparentTo(self.static_cube)

        self.cube_up_right_edge = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/edge_cubes/cube_up_right_edge.gltf")
        self.cube_up_right_edge.reparentTo(self.static_cube)

        self.cube_back_up_left_corner = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/corner_cubes/cube_back_up_left_corner.gltf")
        self.cube_back_up_left_corner.reparentTo(self.static_cube)

        self.cube_back_up_edge = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/edge_cubes/cube_back_up_edge.gltf")
        self.cube_back_up_edge.reparentTo(self.static_cube)

        self.cube_back_up_right_corner = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/corner_cubes/cube_back_up_right_corner.gltf")
        self.cube_back_up_right_corner.reparentTo(self.static_cube)

        # Load front face cubes
        self.cube_front_left_edge = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/edge_cubes/cube_front_left_edge.gltf")
        self.cube_front_left_edge.reparentTo(self.static_cube)

        self.cube_front_center = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/center_cubes/cube_front_center.gltf")
        self.cube_front_center.reparentTo(self.static_cube)

        self.cube_front_right_edge = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/edge_cubes/cube_front_right_edge.gltf")
        self.cube_front_right_edge.reparentTo(self.static_cube)

        # Load back face cubes
        self.cube_back_right_edge = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/edge_cubes/cube_back_right_edge.gltf")
        self.cube_back_right_edge.reparentTo(self.static_cube)

        self.cube_back_center = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/center_cubes/cube_back_center.gltf")
        self.cube_back_center.reparentTo(self.static_cube)

        self.cube_back_left_edge = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/edge_cubes/cube_back_left_edge.gltf")
        self.cube_back_left_edge.reparentTo(self.static_cube)

        # Load left face cube
        self.cube_left_center = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/center_cubes/cube_left_center.gltf")
        self.cube_left_center.reparentTo(self.static_cube)

        # Load left face cube
        self.cube_right_center = self.viewer3D.loader.loadModel(os.getcwd() + "/3dModels/center_cubes/cube_right_center.gltf")
